                ...
                <div class="regform-indent p-4">
                    ...
                    <div class="row justify-content-center align-items-end g-3 p-5">
                        ...
                        <div class="container p-4">
                            ...
                            <p>By creating an account, you agree to our <a href="terms.php">Terms and Conditions</a> and <a href="privacy.php">Privacy Policy</a>.</p>
                        ...
                        <div class="row justify-content-center align-items-end g-3 py-2">
                            <p>Already have an account? <a class="" type="button" data-bs-toggle="modal" data-bs-target="#loginModal">Sign In</a>                   
                        </div>
                    </div>
